package edu.berkeley.harrislab.samplemanager.web.listener;
...
Initializable { 
	...
	public void onPostDelete(PostDeleteEvent event) {
		try {
            ...
            final String entityName = event.getEntity().toString();
            final Date transTime = new Date(); // new Date(event.getSource().getTimestamp());  
            SpecimenStorage specSto = (SpecimenStorage) event.getEntity();
            ...
            if (event.getEntity() instanceof Auditable){
	            ...
	            session.insert(new AuditTrail(specSto.getSpecimen().getSystemId(), entityClass, entityName, "DELETED", null, null, OPERATION_TYPE_DELETE, actorId, transTime));
