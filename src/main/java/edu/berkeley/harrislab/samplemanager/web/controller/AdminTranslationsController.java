...
public class AdminTranslationsController {
	private static final Logger logger = LoggerFactory.getLogger(AdminTranslationsController.class);
    ...
    public String obtenerEntidades(Model model) throws ParseException { 	
    	...
    	List<MessageResource> entidades = messageResourceService.loadAllMessages();
    	model.addAttribute("entidades", entidades);
    	this.visitsService.saveUserPages(this.usuarioService.getUser(SecurityContextHolder.getContext().getAuthentication().getName()),new Date(),"admintranslationspage");
    ...
    public ModelAndView showEntity(@PathVariable("messageKey") String messageKey) {
        ...
        if(entidad==null){
        	...
        	mav = new ModelAndView("admin/translations/viewForm");
            ...
            this.visitsService.saveUserPages(this.usuarioService.getUser(SecurityContextHolder.getContext().getAuthentication().getName()),new Date(),"adminviewtranslationpage");
        }
        return mav;
    }
    ...
    public String disableEntity(@PathVariable("messageKey") String messageKey, 
    	...
    	if(entidad!=null){
    		...
    		redirecTo = "redirect:/admin/translations/"+entidad.getMessageKey()+"/";
    	}
    	else{
    		redirecTo = "403";
    	}
	...
	public String initEnterForm(@PathVariable("messageKey") String messageKey, Model model) {
		...
		if(entidadEditar!=null){
		    ...
		    this.visitsService.saveUserPages(this.usuarioService.getUser(SecurityContextHolder.getContext().getAuthentication().getName()),new Date(),"adminedittranslationpage");
