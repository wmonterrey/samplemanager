        		...
        		<div class="layout-content">
        			<!-- Content -->
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <spring:url value="/admin/studies/newEntity/" var="newEntity"/>
			            <spring:url value="/admin/studies/uploadEntity/" var="uploadEntity"/>	
			            ...
			            <div class="card mb-4" id="entity-element">
			              <h6 class="card-header with-elements">
			                ...
			                <div class="card-header-title"><spring:message code="studies" /></div>
			              </h6>
			                  ...
			                  <div class="card-body">
				                ...
				                <tbody>
				                	<c:forEach items="${entidades}" var="entidad">
				                		<tr>
				                			<spring:url value="/admin/studies/{systemId}/"
				                                        var="viewUrl">
				                                <spring:param name="systemId" value="${entidad.systemId}" />
				                            </spring:url>
				                            <spring:url value="/admin/studies/editEntity/{systemId}/"
				                                        var="editUrl">
				                                <spring:param name="systemId" value="${entidad.systemId}" />
				                            </spring:url>
