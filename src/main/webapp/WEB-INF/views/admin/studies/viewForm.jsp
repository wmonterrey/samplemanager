			            ...
			            <div class="card mb-4" id="viewentity-element">
			              ...
			              <div class="col-md-12 col-lg-12 col-xl-12">
			                ...
			                <div class="row justify-content-end">
			                	<spring:url value="/admin/studies/" var="listUrl"></spring:url>	
			                	<spring:url value="/admin/studies/editEntity/{systemId}/"
				                                        var="editUrl">
	                                <spring:param name="systemId" value="${entidad.systemId}" />
	                            </spring:url>
                         		<spring:url value="/admin/studies/disableEntity/{systemId}/" var="disableUrl">
                              		<spring:param name="systemId" value="${entidad.systemId}" />
                         		</spring:url>
                         		<spring:url value="/admin/studies/enableEntity/{systemId}/" var="enableUrl">
                           			<spring:param name="systemId" value="${entidad.systemId}" />
                         		</spring:url>
