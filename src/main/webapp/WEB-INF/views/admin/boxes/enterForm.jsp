...
<body>
	<div class="page-loader">
  	...
  	<!-- urls -->
    <spring:url value="/admin/boxes/saveEntity/" var="saveUrl"></spring:url>
         			...
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <div class="card mb-4" id="edit-element">
			              <h6 class="card-header with-elements">
			                ...
			                <div class="card-header-title"><spring:message code="boxes" /></div>
			              </h6>
				                      ...
				                      <form action="#" autocomplete="off" id="edit-form">
					                    ...
					                    <div class="form-group">
					                      <div class="input-group">
					                        ...
					                        <input type="text" id="rows" name="rows" value="${entidad.rows}"  
					                        	data-toggle="tooltip" data-placement="right" title="<spring:message code="rows" />" 
					                        		class="form-control" placeholder="<spring:message code="rows" />">
					                      </div>
					                    </div>
					                    ...
					                    <div class="form-group">
					                      <div class="input-group">
					                        ...
					                        <input type="text" id="columns" name="columns" value="${entidad.columns}"  
					                        	data-toggle="tooltip" data-placement="right" title="<spring:message code="columns" />" 
					                        		class="form-control" placeholder="<spring:message code="columns" />">
					                      </div>
					                    </div>
