        		...
        		<div class="layout-content">
        			<!-- Content -->
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <spring:url value="/admin/boxes/newEntity/" var="newEntity"/>
			            <spring:url value="/admin/boxes/uploadEntity/" var="uploadEntity"/>	
			                  ...
			                  <div class="card-body">
				                ...
				                <thead>
				                	<tr>
					                    ...
					                    <th><spring:message code="rows" /></th>
					                    <th><spring:message code="columns" /></th>
				                ...
				                <tbody>
				                	<c:forEach items="${entidades}" var="entidad">
				                		<tr>
				                			<spring:url value="/admin/boxes/{systemId}/"
				                                        var="viewUrl">
