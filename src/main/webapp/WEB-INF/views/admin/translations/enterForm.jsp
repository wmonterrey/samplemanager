...
<body>
	<div class="page-loader">
  	...
  	<!-- urls -->
    <spring:url value="/admin/translations/saveEntity/" var="saveUrl"></spring:url>
    <spring:url value="/admin/translations/" var="listUrl"></spring:url>	
	<!-- Layout wrapper -->
         			...
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <div class="card mb-4" id="edit-element">
			              <h6 class="card-header with-elements">
			                ...
			                <div class="card-header-title"><spring:message code="translations" /></div>
			              </h6>
				                    ...
				                    <div class="col-md-8">
				                      <form action="#" autocomplete="off" id="edit-form">
					                      ...
					                      <div class="input-group">
					                        ...
					                        <input type="text" id="messageKey" name="messageKey" readonly value="${entidad.messageKey}"  
					                    ...
					                    <div class="form-group">
					                      <div class="input-group">
					                        ...
					                        <input type="text" id="english" name="english"  value="${entidad.english}"
					                    ...
					                    <div class="form-group">
					                      <div class="input-group">
					                        ...
					                        <input type="text" id="spanish" name="spanish" value="${entidad.spanish}"
  ...
  <!-- Mensajes -->
	...
	<script>
		jQuery(document).ready(function() {
	    	...
	    	$("li.translations").addClass("active");
	    });
	</script>
