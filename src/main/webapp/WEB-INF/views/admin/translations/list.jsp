			                  ...
			                  <div class="card-body">
				                ...
				                <tbody>
				                	<c:forEach items="${entidades}" var="entidad">
				                		<tr>
				                			<spring:url value="/admin/translations/{messageKey}/"
				                                        var="viewUrl">
				                            ...
				                            <td>
				                            	<a href="${fn:escapeXml(viewUrl)}" data-toggle="tooltip" data-placement="bottom" title="<spring:message code="addEntidadToolTip" />" class="btn btn-outline-primary btn-sm"><i class="fa fa-search"></i></a>
