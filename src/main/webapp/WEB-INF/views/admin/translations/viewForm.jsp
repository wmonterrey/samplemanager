         			...
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <div class="card mb-4" id="viewentity-element">
			              <h6 class="card-header with-elements">
			                <div class="card-header-title"><i class="fa fa-database"></i>&nbsp;<strong><c:out value="${entidad.messageKey}" /></strong></div>
			              </h6>
			              <div class="col-md-12 col-lg-12 col-xl-12">
			                ...
			                <div class="row justify-content-end">
			                	...
			                	<spring:url value="/admin/translations/editEntity/{messageKey}/"
				                                        var="editUrl">
	                                <spring:param name="messageKey" value="${entidad.messageKey}" />
	                            </spring:url>
                         		<spring:url value="/admin/translations/disableEntity/{messageKey}/" var="disableUrl">
                              		<spring:param name="messageKey" value="${entidad.messageKey}" />
                         		</spring:url>
                         		<spring:url value="/admin/translations/enableEntity/{messageKey}/" var="enableUrl">
                           			<spring:param name="messageKey" value="${entidad.messageKey}" />
                         		</spring:url>
