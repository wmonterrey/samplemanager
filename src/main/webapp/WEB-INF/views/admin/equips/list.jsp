        		...
        		<div class="layout-content">
        			<!-- Content -->
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <spring:url value="/admin/equips/newEntity/" var="newEntity"/>
			            <spring:url value="/admin/equips/uploadEntity/" var="uploadEntity"/>	
			                  ...
			                  <div class="card-body">
				                ...
				                <thead>
				                	<tr>
					                    ...
					                    <th><spring:message code="equipType" /></th>
					                    <th><spring:message code="lab" /></th>
				                ...
				                <tbody>
				                	<c:forEach items="${entidades}" var="entidad">
				                		<tr>
				                			<spring:url value="/admin/equips/{systemId}/"
				                                        var="viewUrl">
