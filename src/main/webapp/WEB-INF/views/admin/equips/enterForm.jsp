...
<body>
	<div class="page-loader">
  	...
  	<!-- urls -->
    <spring:url value="/admin/equips/saveEntity/" var="saveUrl"></spring:url>
         			...
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <div class="card mb-4" id="edit-element">
			              <h6 class="card-header with-elements">
			                ...
			                <div class="card-header-title"><spring:message code="equips" /></div>
			              </h6>
			                  ...
			                  <div class="card-body demo-vertical-spacing">
				                    ...
				                    <div class="col-md-8">
				                      <form action="#" autocomplete="off" id="edit-form">
					                    ...
					                    <div class="form-group">
					                    	<label class="form-label"><spring:message code="equipType" /></label> <span class="badge badge-dot badge-danger"></span>
						                	<select class="select2-control form-control" id=equipType name="equipType" style="width: 100%" data-allow-clear="false">
						                		<option value=""></option>
					                        	<c:forEach items="${types}" var="type">
													<c:choose> 
														<c:when test="${type.catKey eq entidad.type}">
					                    ...
					                    <div class="form-group">
					                    	<label class="form-label"><spring:message code="lab" /></label> <span class="badge badge-dot badge-danger"></span>
						                	<select class="select2-control form-control" id="lab" name="lab" style="width: 100%" data-allow-clear="false">
						                		<option value=""></option>
					                        	<c:forEach items="${labs}" var="lab">
													<c:choose> 
														<c:when test="${lab.labSystemId eq entidad.lab.labSystemId}">
															<option selected value="${lab.labSystemId}"><spring:message code="${lab.labName}" /></option>
														</c:when>
														<c:otherwise>
															<option value="${lab.labSystemId}"><spring:message code="${lab.labName}" /></option>
														</c:otherwise>
													</c:choose> 
												</c:forEach>
						                	</select>
