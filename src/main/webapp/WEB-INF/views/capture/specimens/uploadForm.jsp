        			...
        			<!-- Content -->
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <div class="card mb-4">
			              ...
			              <div class="card-body">
			                <spring:url value="/capture/specimens/uploadEntityFile/" var="uploadUrl"></spring:url>
			                <form method="POST" action="${fn:escapeXml(uploadUrl)}" enctype="multipart/form-data">
								...
								<div class="row justify-content-end">
									<button type="submit" data-toggle="tooltip" data-placement="bottom" title="<spring:message code="importEntityToolTip" />" class="btn rounded-pill btn-outline-primary"><i class="fa fa-check"></i> <spring:message code="import" /></button>
								</div>
			                </form>
