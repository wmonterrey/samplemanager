        		...
        		<div class="layout-content">
        			<!-- Content -->
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <spring:url value="/capture/subjects/newEntity/" var="newEntity"/>
			            <spring:url value="/capture/subjects/uploadEntity/" var="uploadEntity"/>	
			                  ...
			                  <div class="card-body">
				                ...
				                <thead>
				                	<tr>
					                    ...
					                    <th><spring:message code="enrollmentDate" /></th>
				                ...
				                <tbody>
				                	<c:forEach items="${entidades}" var="entidad">
				                		<tr>
				                            ...
				                            <spring:url value="/capture/subjects/editEntity/{systemId}/"
				                                        var="editUrl">
				                                <spring:param name="systemId" value="${entidad.systemId}" />
				                            </spring:url>
				                            <td><c:out value="${entidad.subjectId}" /></td>
				                            <td><c:out value="${entidad.studyId.name}" /></td>
				                            <td><fmt:formatDate value="${entidad.enrollmentDate}" var="fecEnr" pattern="yyyy-MM-dd" /><c:out value="${fecEnr}" /></td>
