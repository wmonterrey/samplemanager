			              ...
			              <div class="col-md-12 col-lg-12 col-xl-12">
			                ...
			                <div class="card-body table-responsive">
			                	<table id="lista_datos" class="table table-striped table-bordered" width="100%">
					                <tbody>
					                	...
					                	<tr>
					                		<td><spring:message code="study" /></td>
					                		<td><c:out value="${entidad.studyId.name}" /></td>
					                	</tr>
					                	<tr>
					                		<td><spring:message code="enrollmentDate" /></td>
					                		<td><c:out value="${entidad.enrollmentDate}" /></td>
					                	</tr>
					                	<tr>
			                ...
			                <div class="row justify-content-end">
			                	...
			                	<spring:url value="/capture/subjects/editEntity/{systemId}/"
                         		...
                         		<spring:url value="/capture/subjects/disableEntity/{systemId}/" var="disableUrl">
                              		<spring:param name="systemId" value="${entidad.systemId}" />
                         		</spring:url>
                         		<spring:url value="/capture/subjects/enableEntity/{systemId}/" var="enableUrl">
                           			<spring:param name="systemId" value="${entidad.systemId}" />
                         		</spring:url>
